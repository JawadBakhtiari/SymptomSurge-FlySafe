...
resource "null_resource" "build_Health" {
  ...
  provisioner "local-exec" {
    command = "bash ${path.module}/../code/Health/build.sh"
  }
}
...
data "archive_file" "Health" {
  type        = "zip"
  output_path = "${path.module}/../code/Health.zip" # TODO: change here
  source_dir  = "${path.module}/../code/Health"     # TODO: change here

  depends_on = [
    null_resource.build_Health # TODO: change here
  ]
}

# Tells Terraform to create an AWS lambda function
# - Filename here corresponds to the output_path in archive_file.Health.
...
resource "aws_lambda_function" "Health" {
  ...
  function_name = "${var.group_name}_${terraform.workspace}_Health" # TODO: change here
  handler       = "handler.handler"
  runtime       = "python3.9" # TODO: change here

  role             = aws_iam_role.iam_for_lambda.arn
  source_code_hash = data.archive_file.Health.output_base64sha256 # TODO: change here
...
resource "aws_lambda_permission" "Health" {
  ...
  function_name = aws_lambda_function.Health.function_name # TODO: change here
  principal     = "apigateway.amazonaws.com"

  source_arn = "${data.aws_apigatewayv2_api.api_gateway_global.execution_arn}/${terraform.workspace}/${var.group_name}/Health" # TODO: change here
}
...
resource "aws_apigatewayv2_integration" "Health" {
  ...
  integration_uri    = aws_lambda_function.Health.invoke_arn # TODO: change here
...
resource "aws_apigatewayv2_route" "Health" {
  api_id    = var.gateway_api_id
  route_key = "GET /${var.group_name}/Health" # TODO: change here

  target = "integrations/${aws_apigatewayv2_integration.Health.id}" # TODO: change here
...
resource "aws_cloudwatch_log_group" "Health_log" {
  name              = "/aws/lambda/${aws_lambda_function.Health.function_name}" # TODO: change here
  retention_in_days = 7
  lifecycle {
